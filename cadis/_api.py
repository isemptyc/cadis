...
SCHEMA_VERSION = "1"
VERSION = __version__
SUPPORTED_ISO2 = ["JP", "TW", "GB", "IT", "KR", "SE", "NO", "DK", "BE", "NL", "FR", "DE", "ES", "PT", "FI", "IS", "US", "CA", "AU", "NZ", "CH", "AT", "PL", "LU", "CZ", "SG", "MY", "TH", "ID", "GR", "TR", "BR", "IN", "MX", "PH", "VN", "AR", "CL", "CO", "PE", "BO", "EC", "GY", "PY", "SR", "UY", "VE", "BS", "BZ", "CR", "CU", "SV", "GT", "HT", "DO", "HN", "JM", "NI", "PA", "AF", "AM", "AZ", "SD", "SS", "ZA", "SO", "SL", "SC", "GM", "SN", "ST", "SH", "RW", "NG", "NE", "NA", "MZ", "MA", "MU", "MR", "ML", "MW", "MG", "LY", "LR", "LS", "KE", "CI", "GW", "GN", "GH", "GA", "ET", "ER", "GQ", "EG", "DJ", "CD", "CG", "KM", "TD", "CF", "CV", "CM", "BI", "BF", "BW", "BJ", "AO", "DZ", "YE", "UZ", "TM", "TJ", "SY", "LK", "PK", "KP", "NP", "MM", "MN", "MV", "BN", "LB", "LA", "KG", "KZ", "JO", "PS", "IL", "IQ", "IR", "AE", "SA", "QA", "OM", "KW", "BH", "TL", "KH", "BT", "BD", "AL", "BA", "BG", "HR", "EE", "HU", "LV", "LT", "MC", "ME", "RO", "RS", "SK", "SI", "CY", "GE", "XK", "MK", "MD", "UA"]
