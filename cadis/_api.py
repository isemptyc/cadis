...
SCHEMA_VERSION = "1"
VERSION = __version__
SUPPORTED_ISO2 = ["JP", "TW", "GB", "IT", "KR", "SE", "NO", "DK", "BE", "NL", "FR", "DE", "ES", "PT", "FI", "IS", "US", "CA", "AU", "NZ", "CH", "AT", "PL", "LU", "CZ", "SG", "MY", "TH", "ID", "GR", "TR", "BR", "IN", "MX", "PH", "VN", "AR", "CL", "CO", "PE", "AL", "BA", "BG", "HR", "EE", "HU", "LV", "LT", "MC", "ME", "RO", "RS", "SK", "SI", "CY", "GE", "XK", "MK", "MD", "UA"]
